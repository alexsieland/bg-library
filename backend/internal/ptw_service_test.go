...
func TestPlayToWinServiceInsertPlayToWinGame(t *testing.T) {
	t.Run("Should create play to win game with checkpoint transactions and commit when no errors occur", func(t *testing.T) {
	...
	t.Run("Should restore play to win game and return it when unique constraint violation occurs during creation", func(t *testing.T) {
		lib, mockDB := setupTestLibraryService()
		svc := PlayToWinService{libraryService: lib}
...
func TestPlayToWinService_DeletePlayToWinGameByLibraryGameId(t *testing.T) {
	t.Run("Should delete play to win game when no errors occur", func(t *testing.T) {
		lib, mockDB := setupTestLibraryService()
		svc := PlayToWinService{libraryService: lib}
...
func TestPlayToWinService_ClaimPlayToWinGame(t *testing.T) {
	t.Run("Should return error when no winner exists", func(t *testing.T) {
		lib, mockDB := setupTestLibraryService()
		svc := PlayToWinService{libraryService: lib}
	...
	t.Run("Should claim play to win game when winner exists", func(t *testing.T) {
		lib, mockDB := setupTestLibraryService()
		svc := PlayToWinService{libraryService: lib}
...
func TestPlayToWinService_UpdatePlayToWinGameWinner(t *testing.T) {
	t.Run("Should update play to win game winner when no errors occur", func(t *testing.T) {
		lib, mockDB := setupTestLibraryService()
		svc := PlayToWinService{libraryService: lib}
...
func TestPlayToWinService_ResetPlayToWinGameWinners(t *testing.T) {
	t.Run("Should reset all play to win game winners when no errors occur", func(t *testing.T) {
		lib, mockDB := setupTestLibraryService()
		svc := PlayToWinService{libraryService: lib}
