...
func (q *Queries) GetPlayToWinGame(ctx context.Context, playToWinID pgtype.UUID) (VwPlayToWinGameOverview, error) {
	row := q.db.QueryRow(ctx, getPlayToWinGame, playToWinID)
