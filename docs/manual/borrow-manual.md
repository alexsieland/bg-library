...
![The Borrow page showing a search bar and a table of games with Borrow buttons](img/Borrow_Page.png)
...
![The borrow pop-up window with a patron name search field and a Borrow button](img/Borrow_Modal.png)
