...
![The Add Patron pop-up window with a Name field and a Barcode field](img/Patron_Modal.png)

A pop-up window will appear.

---

### 4. Enter the patron's full name

Type the patron's full name into the **Name** field.
...
Click the **Add Patron** button inside the pop-up window to save.

---

### 7. Confirm the patron was added successfully
